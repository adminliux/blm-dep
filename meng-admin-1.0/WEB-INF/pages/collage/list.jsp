    ...
    <div class="mt-20" >
        ...
        <script type="text/html" id="f1">
            ...
            <tr>
                ...
                <td style="text-align:center;vertical-align:middle;">{{if good.user==NULL}}{{else}}{{good.user.nickname}}{{/if}}</td>
                <td style="text-align:center;vertical-align:middle;">{{$timestampFormatYMDHM good.gmtDatetime}}</td>
                <td style="text-align:center;vertical-align:middle;"><a onclick="layer_show('成员信息','${path}/page/collage/pinlun?id={{good.id}}','800','600')">{{if good.size==NULL}}0{{else}}{{good.size}}{{/if}}</a></td>
                <td style="text-align:center;vertical-align:middle;">{{good.goodId}}</td>
                <td style="text-align:center;vertical-align:middle;">{{if good.liveCourses==NULL}}{{else}}{{good.liveCourses.roomTitle}}{{/if}}</td>
                <td style="text-align:center;vertical-align:middle;">{{if good.liveCourses==NULL}}{{else}}{{good.liveCourses.spellPrice}}{{/if}}</td>
