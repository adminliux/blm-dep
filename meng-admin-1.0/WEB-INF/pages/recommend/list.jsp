...
<body>
<nav class="breadcrumb"><i class="Hui-iconfont">&#xe67f;</i> 首页 <span class="c-gray en">&gt;</span> 主页管理 <span
            ...
            <script type="text/html" id="f1">
                ...
                <tr>
                    ...
                    <td style="text-align:center;vertical-align:middle;">
                        {{if good.type=="VIDEO"}}<a href="${path}/page/recommend/video/list?id={{good.relationId}}">{{good.relationId}}
                        查看</a>
                        {{else if good.type=="CURRICULUM"}}<a
                            href="${path}/page/recommend/live/course/list?id={{good.relationId}}">{{good.relationId}}
                        查看</a>
                        {{else if good.type =="ACTIVITY"}}<a
                            href="${path}/page/recommend/activity/list?id={{good.relationId}}">{{good.relationId}}
                        查看</a>
                        {{else if good.type =="LIVE"}}<a href="${path}/page/recommend/live/list?id={{good.relationId}}">{{good.relationId}}
                        查看</a>
                        {{else}}{{/if}}
                    </td>
                    ...
                    <!-- 用户审核 -->
                    <td style="text-align:center;vertical-align:middle;">
                        {{if good.sort==1}}{{else}}<img src="${path}/resources/static/h-ui/images/bin/up.png"
                                                        onClick="member_up('{{good.sort}}','{{good.id}}')"
                                                        title="上"><br/>{{/if}}
                    </td>
                    <td style="text-align:center;vertical-align:middle;">
                        <img src="${path}/resources/static/h-ui/images/bin/down.png"
                             onClick="member_down('{{good.sort}}','{{good.id}}')" title="下">
                    </td>
                    <td style="text-align:center;vertical-align:middle;">
