...
<body>
<nav class="breadcrumb"><i class="Hui-iconfont">&#xe67f;</i> 首页 <span class="c-gray en">&gt;</span> 用户管理<span class="c-gray en">&gt;</span> 明星列表<a class="btn btn-success radius r" style="line-height:1.6em;margin-top:3px" href="javascript:location.replace(location.href);" title="刷新" ><i class="Hui-iconfont">&#xe68f;</i></a></nav>
...
<script type="text/html" id="f1">
    ...
    <tr>
        ...
        <td style="text-align:center;vertical-align:middle;">{{if good.user == null}}无{{else}}{{good.user.nickname}}{{/if}}</td>
        <td style="text-align:center;vertical-align:middle;">{{if good.user == null}}无{{else if good.user.type=="USER"}}用户{{else if good.user.type=="TEACHER"}}老师{{/if}}</td>
        <td style="text-align:center;vertical-align:middle;">{{if good.user == null}}无{{else}}{{good.user.phoneNumber}}{{/if}}</td>
        <td style="text-align:center;vertical-align:middle;">{{if good.user == null}}无{{else}}{{$timestampFormatYMDHM good.user.gmtDatetime}}{{/if}}</td>

        <td style="text-align:center;vertical-align:middle;">
            <img src="${path}/resources/static/h-ui/images/bin/up.png" onClick="member_up(this,'{{good.id}}','{{good.sort}}')" title="上移">
            <img src="${path}/resources/static/h-ui/images/bin/down.png" onClick="member_down(this,'{{good.id}}','{{good.sort}}')" title="下移">
...
<div class="col-xs-8 col-sm-9 col-xs-offset-4 col-sm-offset-3">
    <input class="btn btn-primary radius" type="button" value="&nbsp;&nbsp;添加&nbsp;&nbsp;" onclick="member_show(' ','${path}/page/user/addstar','10001','1260','400')">
</div>
