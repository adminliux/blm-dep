<%@ page language="java" contentType="text/html; charset=utf-8"
	pageEncoding="utf-8"%>
	<!-- 引入tag.jsp -->
	<%@include file="../../../../../../bailem/web-app/meng-admin/src/main/webapp/WEB-INF/pages/public/tag.jsp"%>
	<!DOCTYPE html>
<html lang="en">
<head>
	<title>用户主页面</title>
	...
	<div class="mt-20" >
		...
		{{each data.list as good}}
			<tr>
				...
				<td style="text-align:center;vertical-align:middle;"><input value="{{good.praiseSum}}" onchange="updatePraiseSum(this.value,{{good.id}})" n /></td>
